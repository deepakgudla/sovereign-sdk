...
use crate::{DEFAULT_POLLING_TIMEOUT,DEFAULT_POLLING_INTERVAL};
// Rollup with AvailDa
...
impl RollupBlueprint for AvailDemoRollup {
    ...
    async fn create_prover_service(&self, prover_config: RollupProverConfig, rollup_config: &RollupConfig<Self::DaConfig>, da_service: &Self::DaService) -> Self::ProverService {
